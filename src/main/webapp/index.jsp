...
<body class="easyui-layout">
	...
	<div class="header" data-options="region:'north'" style="height:51px">
		<div class="logo"></div>
		<ul class="nav">
			<li><a href="http://www.centrixlink.com" target="_blank">公司网站</a></li>
			<li><a href="/sso/logout">账号切换</a></li>
			<li><a href="/sso/logout">安全退出</a></li>
		</ul>
	</div>
	...
	<div data-options="region:'south'" style="height:26px;">
		<div class="copyright">
			Copyright©版权所有，<a href="http://www.emar.com" target="_blank">北京xx在线科技有限公司</a>
		</div>
	</div>
